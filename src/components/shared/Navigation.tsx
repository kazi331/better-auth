                    ...
                    <div className="hidden md:flex items-center space-x-2" role="menubar">
                        {navLinks.map((menu) => (
                            <Link
                                key={menu.href}
                                href={menu.href}
                                className={`px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus:ring-primary/60 focus-visible:ring-offset-2 ${isActive(menu.href)
                ...
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50 border-t border-gray-200 shadow-lg">
                    {navLinks.map((menu) => (
                        <Link
                            ...
                            href={menu.href}
                            onClick={closeMenu}
                            className={`block px-3 py-3 rounded-md text-base font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary/60 focus:ring-offset-2 ${isActive(menu.href)
